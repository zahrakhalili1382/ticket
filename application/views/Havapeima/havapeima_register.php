	...
	<div class="row">
        ...
        <div class="row">
        	<div class="main-form">
            	<div class="top">
                	<ul>
                    	<li><i class='fa fa-plus'></i><p> ثبت هواپیما
                            </p></li>
                        <li>
                            <?php
                ...
                <div class="body">
                    ...
                    $data=$CI->Get_All_Airlines();
                        echo form_open_multipart('Havapeima/Register');
                    ?>
                    ...
                    <div class="form_row">
                        ...
                        <input type="text" name="havapeima_name">
                    </div>
                    <div class="form_row">
                        <label> نام شرکت هواپیمایی  : </label>
                        <select name="havapeima_airlineName">
                            <?php
                    ...
                    <div class="form_row">
                        ...
                        <input type="text" name="havapeima_Code">
                    </div>
                    <div class="form_row">
						<input type="submit" value="ثبت هواپیما ">
                    </div>
                        <?php
                        echo form_close();
                        ?>
