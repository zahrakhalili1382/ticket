	...
	<div class="row">
        ...
        <div class="row">
        	<div class="main-form">
            	<div class="top">
                	<ul>
                    	<li><i class='fa fa-plus'></i><p> ویرایش پرواز
                            </p></li>
                        <li>
                            <?php
                ...
                <div class="body">
                    ...
                    if(isset($data_result)){
                        foreach ($data_result->result() as $row){
                            $data['parvaz_mabda']=$row->parvaz_mabda;
                            $data['parvaz_maghsad']=$row->parvaz_maghsad;
                            $data['parvaz_zarfiyat']=$row->parvaz_zarfiyat;
                            $data['parvaz_gheymat']=$row->parvaz_gheymat;
                            $data['parvaz_date']=$row->parvaz_date;
                            $data['parvaz_time']=$row->parvaz_time;
                            $data['parvaz_code']=$row->parvaz_code;
                        }
                    }
                        echo form_open_multipart('Parvaz/Update');
                    ?>
                    <div class="col-lg-6 col-md-7 col-sm-8 col-xs-12 right">
                        ...
                        <div class="form_row">
                            ...
                            <input type="text" name="parvaz_zarfiyat" value="<?=$data['parvaz_zarfiyat']?>">
                        </div>
                        <div class="form_row">
                            <label>  قیمت هر نفر : <?php echo form_error('parvaz_gheymat')?></label>
                            <input type="text" name="parvaz_gheymat" value="<?=$data['parvaz_gheymat']?>" placeholder="2.900.000R">
                        </div>
                        <div class="form_row">
                            <label>  تاریخ پرواز : <?php echo form_error('parvaz_date') ?></label>
                            <input type="text" name="parvaz_date" value="<?=$data['parvaz_date']?>" placeholder="97/4/20">
                        </div>
                        <div class="form_row">
                            <label> ساعت پرواز  : <?php echo form_error('parvaz_time') ?></label>
                            <input type="text" name="parvaz_time" value="<?=$data['parvaz_time']?>" placeholder="19:30">
                        </div>
                        <div class="form_row">
                        ...
                        <div class="form_row">
                            <input type="submit" value="ویرایش پرواز ">
                        </div>
                        <?php
                        echo form_close();
                        ?>
